...
x1_cl,y1_cl, x2_cl,y2_cl = 300,0, 300,600 #position of crossing line
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        for i, detections in enumerate(tracked_objects):
            ...
            cv2.rectangle(orig_image, (box[0], box[1]), (box[0]+110, box[1]-50), color, -1)
            cv2.putText(orig_image, label, (box[0], box[1]-6), cv2.FONT_HERSHEY_SIMPLEX, 0.5, black, 1) 

            # Put Object id
            cv2.putText(orig_image, "object id {}".format(obj_id), (box[0], box[1]-22), cv2.FONT_HERSHEY_SIMPLEX, 0.5, black, 1)
            ...
            cv2.putText(orig_image, "position {}".format(result), (box[0], box[1]-38), cv2.FONT_HERSHEY_SIMPLEX, 0.5, black, 1)
        ...
        cv2.rectangle(orig_image, (7,5,80,40),white, -1) #white box
        cv2.rectangle(orig_image, (7,5,80,40),black, 1) #black rectangle
