...
parser.add_argument('--validation_dataset', default='dataset', 
                    help='Dataset directory path')
...
parser.add_argument('--milestones', default="50, 80,100", type=str,
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            if val_loss < minimum_loss:
                ...
                decision='Loss decreased'
            else: decision='Loss NOT decreased'
            ...
            logging.info(
                ...
                f"Validation Classification Loss: {val_classification_loss:.4f}, " + decision
            )
            model_path = os.path.join(args.checkpoint_folder, f"{args.net}-Epoch-{epoch}-Loss-{val_loss}.pth")
            if decision == 'Loss decreased':
                net.save(model_path)
